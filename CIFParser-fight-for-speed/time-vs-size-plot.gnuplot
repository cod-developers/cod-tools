...
#    	System: Linux 2.6.16-gentoo-r13
#    
...
#    
# set terminal dumb feed  79 24
# set output 'time-vs-size-plot.txt'
unset clip points
set clip one
unset clip two
set bar 1.000000
...
unset grid
set key title ""
set key left top Right noreverse enhanced box linetype -2 linewidth 1.000 samplen 4 spacing 1 width 0 height 0 autotitles
unset label
set label 1 "(null)" at 0, 0, 0 left norotate back nopoint
unset arrow
unset style line
unset style arrow
unset logscale
...
plot "time-vs-size.dat" using 2:3, "time-vs-size.dat" using 2:6
#    EOF
