...
#* almost identical bibliographies are compared. In this case, the DOIs are
#* not provided and the values of the _journal_name_full field do not match.
#* Since the _journal_name_full field values are not compared the
#* bibliographies should be treated as equivalent.
#**
...
my $entry_2 = {
    'bibliography' => {
        '_journal_name_full'    => 'Not the Journal of Applied Crystallography',
        '_journal_year'         => 2016,
        '_journal_volume'       => 49,
        '_journal_issue'        => 1,
        '_journal_page_first'   => 292,
