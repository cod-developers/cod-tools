...
#* various data items that explicitly state that the entry is a theoretically
#* determined one.
#**
...
my $data_block_2 =
{
  ...
  'tags'   => [ '_cod_structure_determination_method' ],
  'loops'  => [],
  'inloop' => {},
  'values' => { '_cod_structure_determination_method' => [ 'theoretical' ] },
  'precisions' => {},
  'types'  => { '_cod_structure_determination_method' => [ 'UQSTRING' ] },
};

my $data_block_3 =
{
  'name'   => 'theoretical_item_3',
  'tags'   => [ '_cod_struct_determination_method' ],
  'loops'  => [],
  'inloop' => {},
  'values' => { '_cod_struct_determination_method' => [ 'theoretical' ] },
  'precisions' => {},
  'types'  => { '_cod_struct_determination_method' => [ 'UQSTRING' ] },
};
