...
#* Tests the way an already existing unlooped data item is inserted into
#* the data block when the loop key matches its data name.
#**
...
# 2 4 3
# 1 5 3
# _unlooped_data_item '42'
##
my $data_block =
{
  'tags'   =>   [ '_a', '_b', '_c', '_unlooped_data_item' ],
  'loops'  => [ [ '_a', '_b', '_c' ] ],
  'inloop' => {
        '_a' => 0,
        '_b' => 0,
...
my $data_name   = '_unlooped_data_item';
my $loop_key    = '_b';
