...
#* contains the '_cod_entry_issue_severity' data item with various flag values.
#**
...
$data_block->{'values'}{'_cod_entry_issue_severity'}[3] = 'note';
$value = COD::CIF::Data::CIF2COD::get_cod_status_from_issue_severity($data_block);
if (defined $value) {
    print 'Data block \'' . $data_block->{'name'} . "' has the '$value' status." . "\n";
} else {
    print 'Data block \'' . $data_block->{'name'} . '\' has an undefined status.' . "\n";
...
$data_block->{'values'}{'_cod_entry_issue_severity'}[2] = 'note';
$value = COD::CIF::Data::CIF2COD::get_cod_status_from_issue_severity($data_block);
if (defined $value) {
    print 'Data block \'' . $data_block->{'name'} . "' has the '$value' status." . "\n";
} else {
...
$data_block->{'values'}{'_cod_entry_issue_severity'}[1] = 'note';
$value = COD::CIF::Data::CIF2COD::get_cod_status_from_issue_severity($data_block);
if (defined $value) {
    print 'Data block \'' . $data_block->{'name'} . "' has the '$value' status." . "\n";
} else {
...
$data_block->{'values'}{'_cod_entry_issue_severity'}[0] = 'unknown';
$data_block->{'values'}{'_cod_entry_issue_severity'}[1] = 'unknown';
$data_block->{'values'}{'_cod_entry_issue_severity'}[2] = 'unknown';
$data_block->{'values'}{'_cod_entry_issue_severity'}[3] = 'unknown';
$value = COD::CIF::Data::CIF2COD::get_cod_status_from_issue_severity($data_block);
if (defined $value) {
    print 'Data block \'' . $data_block->{'name'} . "' has the '$value' status." . "\n";
} else {
