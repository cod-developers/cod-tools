...
INPUT_CIF='tests/inputs/lib/COD/AtomNeighbours/neighbour_list_from_cif/2103766.cif'
#END DEPEND--------------------------------------------------------------------
...
( $data ) = parse_cif( 'tests/inputs/lib/COD/AtomNeighbours/neighbour_list_from_cif/2103766.cif' );
( $dataset ) = @$data;
