...
#* subroutine. Tests the way CIF 1.1 data item values that contain a semicolon
#* (';') as a prefix and various CIF 1.1 and CIF 2.0 delimiter symbols are
#* handled. Values used in this test do not require any additional surrounding
#* delimiters since they are short enough to appear on the same line as
#* the data names and the delimiter symbols appear only in the middle of
#* the uninterupted text strings.
#**
