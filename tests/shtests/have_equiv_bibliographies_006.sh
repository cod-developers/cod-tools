...
#* subroutine. Tests the way the subroutine behaves when two entries contain
#* incomplete bibliographies. Since all data items provided in both entries
#* match the entries are treated as containing equivalent bibliographies.
#**
