...
file. The import statement uses the 'Full' import mode and an unrecognised
on duplicate mode. The import operation should generate a terminal error message.
