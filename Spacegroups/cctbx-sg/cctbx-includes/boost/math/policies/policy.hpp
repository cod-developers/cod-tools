...
struct precision
{
   ...
   //
#if defined _MIPSEB && ( _COMPILER_VERSION <= 730 )
   BOOST_STATIC_CONSTANT(bool, bool_value = (Digits10::value == 0 ));
   BOOST_STATIC_CONSTANT(long, value = ((Digits10::value + 1) * 1000L) / 301L );
...
public:
#if defined _MIPSEB && ( _COMPILER_VERSION <= 730 )
   BOOST_STATIC_CONSTANT(bool, bool_value2 = (Digits2::value > digits2_type::value ));
   typedef typename mpl::if_c<
      bool_value2,
...
private:
   ...
   //
#if defined _MIPSEB && ( _COMPILER_VERSION <= 730 )
   BOOST_STATIC_CONSTANT(int, value2 = (14 - ::boost::mpl::size<reduced_list>::value ) );
  typedef typename detail::append_N<reduced_list, default_policy, value2>::type result_type;
#else
...
struct precision
{
   ...
   typedef typename Policy::precision_type precision_type;
#if defined _MIPSEB && ( _COMPILER_VERSION <= 730 )
   BOOST_STATIC_CONSTANT(bool, bool_value3 = (::std::numeric_limits<Real>::is_specialized == 0) || (::std::numeric_limits<Real>::digits == 0) );
   BOOST_STATIC_CONSTANT(bool, bool_value4 = (::std::numeric_limits<Real>::digits <= precision_type::value) || (Policy::precision_type::value <= 0));
   typedef typename mpl::if_c<
      bool_value3,
      // Possibly unknown precision:
      precision_type,
