...
#ifndef SCITBX_ARRAY_FAMILY_VERSA_APPLY_H
#define SCITBX_ARRAY_FAMILY_VERSA_APPLY_H
...
namespace scitbx { namespace af {
  ...
  inline
  versa<ReturnElementType, AccessorType>
  apply(UnaryOperation const& op,
        versa<ElementType, AccessorType> const& a,
        type_holder<ReturnElementType> /*result_type_holder*/) {
    typedef versa<ReturnElementType, AccessorType> return_array_type;
  ...
  inline
  versa<typename UnaryOperation::result_type, AccessorType>
  apply(UnaryOperation const& op,
        versa<ElementType, AccessorType> const& a) {
...
#endif // SCITBX_ARRAY_FAMILY_VERSA_APPLY_H
