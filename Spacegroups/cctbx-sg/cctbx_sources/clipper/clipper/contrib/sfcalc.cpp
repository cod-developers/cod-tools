...
template class SFcalc_iso_sum<ftype32>;
template class SFcalc_aniso_sum<ftype32>;
template class SFcalc_iso_fft<ftype32>;
template class SFcalc_aniso_fft<ftype32>;

template class SFcalc_iso_sum<ftype64>;
template class SFcalc_aniso_sum<ftype64>;
template class SFcalc_iso_fft<ftype64>;
template class SFcalc_aniso_fft<ftype64>;
