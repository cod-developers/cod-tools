 ...
 */
  ...
  public:
    ...
    //-- Coord_grid deindex( const int& index );
  ...
  public:
    ...
    template<class T> Atom( const T& atom ) : element_(atom.element()), coord_orth_(atom.coord_orth()), occupancy_(atom.occupancy()), u_iso_(atom.u_iso()), u_aniso_orth_(atom.u_aniso_orth()) {}
