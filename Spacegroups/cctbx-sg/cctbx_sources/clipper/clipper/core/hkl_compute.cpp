...
template<class dtype> const Phi_fom<dtype> Compute_phifom_from_abcd<dtype>::operator()( const HKL_info::HKL_reference_index& ih, const ABCD<dtype>& abcd ) const
{
  ...
  if ( !abcd.missing() ) {
    ...
    Range<ftype64> qrange( -50.0, 50.0 );
...
template<class dtype> const F_phi<dtype> Compute_fphi_from_fsigf_phifom<dtype>::operator()( const HKL_info::HKL_reference_index& ih, const F_sigF<dtype>& fsigf, const Phi_fom<dtype>& phifom ) const
{
  const HKL_class& cls = ih.hkl_class();
...
template<class dtype> const F_sigF<dtype> Compute_mean_fsigf_from_fsigfano<dtype>::operator()( const HKL_info::HKL_reference_index& ih, const F_sigF_ano<dtype>& fsigfano ) const
{
...
template<class dtype> const F_sigF<dtype> Compute_diff_fsigf_from_fsigfano<dtype>::operator()( const HKL_info::HKL_reference_index& ih, const F_sigF_ano<dtype>& fsigfano ) const
{
  clipper::datatypes::F_sigF<dtype> fsigf;
...
template<class dtype> const F_phi<dtype> Compute_neg_fphi<dtype>::operator()( const HKL_info::HKL_reference_index& ih, const F_phi<dtype>& fphi1 ) const
{
  clipper::datatypes::F_phi<dtype> fphi;
  if ( !fphi.missing() )
...
template<class dtype> const F_phi<dtype> Compute_add_fphi<dtype>::operator()( const HKL_info::HKL_reference_index& ih, const F_phi<dtype>& fphi1, const F_phi<dtype>& fphi2 ) const
{
  clipper::datatypes::F_phi<dtype> fphi;
...
template<class dtype> const F_phi<dtype> Compute_sub_fphi<dtype>::operator()( const HKL_info::HKL_reference_index& ih, const F_phi<dtype>& fphi1, const F_phi<dtype>& fphi2 ) const
{
  clipper::datatypes::F_phi<dtype> fphi;
  if ( !fphi1.missing() && !fphi2.missing() )
    fphi = clipper::datatypes::F_phi<dtype>( std::complex<dtype>(fphi1) - std::complex<dtype>(fphi2) );
...
template<class dtype> const ABCD<dtype> Compute_add_abcd<dtype>::operator()( const HKL_info::HKL_reference_index& ih, const ABCD<dtype>& abcd1, const ABCD<dtype>& abcd2 ) const
{
  clipper::datatypes::ABCD<dtype> abcd;
...
template<class dtype, class T> const F_sigF<dtype> Compute_FsigF<dtype,T>::operator()( const HKL_info::HKL_reference_index& ih, const T& fsigf ) const
{
...
template class Compute_phifom_from_abcd<ftype32>;
template class Compute_abcd_from_phifom<ftype32>;
template class Compute_fphi_from_fsigf_phifom<ftype32>;
template class Compute_EsigE_from_FsigF<ftype32>;
template class Compute_mean_fsigf_from_fsigfano<ftype32>;
template class Compute_diff_fsigf_from_fsigfano<ftype32>;
template class Compute_neg_fphi<ftype32>;
template class Compute_add_fphi<ftype32>;
template class Compute_sub_fphi<ftype32>;
template class Compute_add_abcd<ftype32>;
...
template class Compute_FsigF<ftype32,F_sigF<ftype32> >;
template class Compute_FsigF<ftype32,F_sigF_ano<ftype32> >;

template class Compute_phifom_from_abcd<ftype64>;
template class Compute_abcd_from_phifom<ftype64>;
template class Compute_fphi_from_fsigf_phifom<ftype64>;
template class Compute_EsigE_from_FsigF<ftype64>;
template class Compute_mean_fsigf_from_fsigfano<ftype64>;
template class Compute_diff_fsigf_from_fsigfano<ftype64>;
template class Compute_neg_fphi<ftype64>;
template class Compute_add_fphi<ftype64>;
template class Compute_sub_fphi<ftype64>;
template class Compute_add_abcd<ftype64>;
...
template class Compute_FsigF<ftype64,F_sigF<ftype64> >;
template class Compute_FsigF<ftype64,F_sigF_ano<ftype64> >;
