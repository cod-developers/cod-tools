...
std::vector<String> String::split(const String sep) const
{
  ...
  while (1) {
    ...
    if (tokend == String::npos) return splitstr;
  }
}
...
template class Vec3<ftype32>;
template class Mat33<ftype32>;
template class Mat33sym<ftype32>;
template class Matrix<ftype32>;

template class Vec3<ftype64>;
template class Mat33<ftype64>;
template class Mat33sym<ftype64>;
template class Matrix<ftype64>;
