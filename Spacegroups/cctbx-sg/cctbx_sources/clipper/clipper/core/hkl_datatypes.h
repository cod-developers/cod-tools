...
namespace clipper
{
  ...
  namespace datatypes
  {
    ...
    {
    public:
      I_sigI() : I_(Util::nan()), sigI_(Util::nan()) {}
    ...
    { public:
      I_sigI_ano() { I_pl_=I_mi_=sigI_pl_=sigI_mi_=cov_=Util::nan(); }
    ...
    {
    public:
      F_sigF() : f_(Util::nan()), sigf_(Util::nan()) {}
    ...
    { public:
      F_sigF_ano() { f_pl_=f_mi_=sigf_pl_=sigf_mi_=cov_=Util::nan(); }
    ...
    */
    ...
    {
    public:
      E_sigE() : E_(Util::nan()), sigE_(Util::nan()) {}
    ...
    { public:
      E_sigE_ano() { E_pl_=E_mi_=sigE_pl_=sigE_mi_=cov_=Util::nan(); }
    ...
    {
    public:
      F_phi() : f_(Util::nan()), phi_(Util::nan()) {}
      void set_null() { Util::set_null(f_); Util::set_null(phi_); }
      static String type() { return "F_phi"; }
      void friedel() { phi_=-phi_; }
      void shift_phase(const ftype& dphi) { phi_+=dphi; }
      bool missing() const { return (Util::is_nan(f_) || Util::is_nan(phi_)); }
      static int data_size() { return 2; }
    ...
    {
    public:
      Phi_fom() : phi_(Util::nan()), fom_(Util::nan()) {}
      void set_null() { Util::set_null(phi_); Util::set_null(fom_); }
      static String type() { return "Phi_fom"; }
      void friedel() { phi_=-phi_; }
      void shift_phase(const ftype& dphi) { phi_+=dphi; }
      bool missing() const { return (Util::is_nan(phi_) || Util::is_nan(fom_)); }
      static int data_size() { return 2; }
