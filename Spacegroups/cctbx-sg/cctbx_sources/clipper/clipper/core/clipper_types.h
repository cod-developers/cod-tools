...
namespace clipper
{
  ...
  */
  ...
  public:
    ...
    inline static Vec3<T> null() { return Vec3<T>( T(Util::nan()), 0, 0 ); }
    //! test for null vector
    inline bool is_null() const { return Util::is_nan( vec[0] ); }
    ...
    String format() const
      { return "("+String(vec[0],10,4)+","+String(vec[1],10,4)+","+String(vec[2],10,4)+")"; }
  ...
  public:
    ...
    bool inline is_null() const { return Util::is_nan( mat[0][0] ); }
  ...
  template<class T> inline Mat33<T> operator +(const Mat33<T>& m1, const Mat33<T>& m2)
    { return Mat33<T>( m1(0,0) + m2(0,0), m1(0,1) + m2(0,1), m1(0,2) + m2(0,2), m1(1,0) + m2(1,0), m1(1,1) + m2(1,1), m1(1,2) + m2(1,2), m1(2,0) + m2(2,0), m1(2,1) + m2(2,1), m1(2,2) + m2(2,2) ); }
  ...
  template<class T> inline Mat33sym<T> operator +(const Mat33sym<T>& m1, const Mat33sym<T>& m2) { return Mat33sym<T>( m1.mat00()+m2.mat00(), m1.mat11()+m2.mat11(),  m1.mat22()+m2.mat22(), m1.mat01()+m2.mat01(), m1.mat02()+m2.mat02(),  m1.mat12()+m2.mat12() ); }
