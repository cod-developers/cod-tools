...
namespace clipper
{
  ...
  namespace data32
  {
    ...
    typedef datatypes::Compute_scale_u<datatypes::I_sigI<ftype32> > Compute_scale_u_isigi;  //!< operator
    typedef datatypes::Compute_scale_u<datatypes::F_sigF<ftype32> > Compute_scale_u_fsigf;  //!< operator
    typedef datatypes::Compute_scale_u<datatypes::F_sigF_ano<ftype32> > Compute_scale_u_fsigfano;  //!< operator
    typedef datatypes::Compute_scale_u<datatypes::F_phi<ftype32> > Compute_scale_u_fphi;  //!< operator
  ...
  namespace data64
  {
    ...
    typedef datatypes::Compute_scale_u<datatypes::I_sigI<ftype64> > Compute_scale_u_isigi;  //!< operator
    typedef datatypes::Compute_scale_u<datatypes::F_sigF<ftype64> > Compute_scale_u_fsigf;  //!< operator
    typedef datatypes::Compute_scale_u<datatypes::F_sigF_ano<ftype64> > Compute_scale_u_fsigfano;  //!< operator
    typedef datatypes::Compute_scale_u<datatypes::F_phi<ftype64> > Compute_scale_u_fphi;  //!< operator
