/* file lib/spacegroup_data.h
    Header file for spacegroup data tables
*/
...
namespace clipper
{
  ...
  namespace data {
    ...
    // ASU function pointer
    typedef bool (*ASUfn)( const int&, const int&, const int& );
    // Spacegroup data record
    struct SGdata { int sghash; const char* hall; const char* hm; char ext; int num; };
    // Laue group data record
    struct LGdata { int lghash; ASUfn asufn; const char* lgname; };
